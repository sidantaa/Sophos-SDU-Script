...
3) Run the command: powershell.exe -ExecutionPolicy Bypass -File .\script.ps1
<img width="1301" height="780" alt="image" src="https://github.com/user-attachments/assets/cecf77c0-f49b-4068-9cda-f3fc05fac373" />
